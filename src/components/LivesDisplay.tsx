...
export function LivesDisplay({ lives, maxLives }: Props) {
    return (
        <div className="absolute -bottom-10 right-0 font-bold text-lg flex gap-1 bg-white/80 dark:bg-black/50 px-3 py-1 rounded-full backdrop-blur-sm shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
